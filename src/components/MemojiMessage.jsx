  ...
  return (
    <div className={`fixed ${getPositionClasses()} z-50 max-w-sm`}>
      ...
      >
        ...
        >
          {/* Glow effect */}
          <div className="absolute -inset-3 bg-gradient-to-r from-blue-600/30 to-purple-600/30 rounded-full blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          ...
          >
            ...
            <div className="relative bg-black/20 backdrop-blur-xl rounded-3xl px-6 py-4 shadow-2xl max-w-xs min-w-[280px] border border-white/20">
              ...
              <button
                ...
                className="absolute -top-2 -right-2 w-6 h-6 bg-purple-500 hover:bg-red-600 text-white rounded-full flex items-center justify-center text-xs font-bold transition-colors duration-200 z-10"
