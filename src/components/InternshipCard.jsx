    ...
    <div className="p-4 rounded-2xl bg-slate-800/40 backdrop-blur-sm border border-white/6 shadow-sm hover:shadow-md transition-all duration-300">
      <div className="flex items-center gap-4">
        {Logo ? (
          ...
          <div className="h-20 w-20 rounded-md bg-gradient-to-r from-indigo-600 to-purple-600 flex items-center justify-center text-white font-bold">{Enterprise?.[0] || 'E'}</div>
        )}
